    ...
    describe("test/list/list-spec", function() {
        ...
        describe("currentIteration property", function () {
            it("should cause a deprecation warning", function () {
                ...
                }, testPage.global, "warn").toHaveBeenCalledWith("currentIteration is deprecated, use :iteration.object instead.", "");
            });
        });
        ...
        describe("objectAtCurrentIteration property", function () {
            it("should cause a deprecation warning", function () {
                ...
                }, testPage.global, "warn").toHaveBeenCalledWith("objectAtCurrentIteration is deprecated, use :iteration.object instead.", "");
            });
        });
